...
Это защищает от случайной перезаписи существующей панели. `FORCE=1` предназначен
для осознанного ремонта или переустановки, а не для штатного обновления. Обычные
обновления выполняйте через **Настройки → Обслуживание → Обновление панели** или
по `docs/safe-update.ru.md`.
